                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                        ...
                        (index) => Container(
                          width:
                              boxWidth, // Will be larger now due to reduced spacing
                          height: boxWidth,
                          margin: EdgeInsets.only(
                              right:
                                  index != 5 ? 8 : 0), // Reduced margin to 8px
                          decoration: BoxDecoration(
                            color: const Color(0xFF2A2B2E),
  ...
  Widget _buildKeyboardButton(String value) {
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(16),
        splashColor: const Color(0xFF4B68FF).withValues(
          red: 75,
          green: 104,
          blue: 255,
          alpha: 51, // 0.2 * 255 for more visible but subtle effect
        ),
        highlightColor: const Color(0xFF4B68FF).withValues(
          red: 75,
          green: 104,
          blue: 255,
          alpha: 26, // 0.1 * 255 for a gentle press state
        ),
        child: Container(
          width: 65,
          height: 45,
